    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtistProduct", x => new { x.ArtistsID, x.ProductsID });
                    table.ForeignKey(
                        name: "FK_ArtistProduct_Artists_ArtistsID",
                        column: x => x.ArtistsID,
                        principalTable: "Artists",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArtistProduct_Products_ProductsID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtistProduct_ProductsID",
                table: "ArtistProduct",
                column: "ProductsID");
